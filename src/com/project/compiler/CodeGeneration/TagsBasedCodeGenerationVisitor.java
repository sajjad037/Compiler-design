...
public class TagsBasedCodeGenerationVisitor extends VisitorBase {
...
//		}
	...
	public void visit(NumNode p_node){
		...
		m_moonDataCode += String.format("%-10s",p_node.moonVarName) + " res 4\n";
		...
		m_moonExecCode += m_mooncodeindent + "sw " + p_node.moonVarName + "(r0)," + localRegister + "\n";
	...
	public void visit(AddOpNode p_node){
		...
		// generate code
		m_moonExecCode += m_mooncodeindent + "% processing: " + p_node.moonVarName + " := " + p_node.getChildren().get(0).moonVarName + " + " + p_node.getChildren().get(1).moonVarName + "\n";
		m_moonExecCode += m_mooncodeindent + "lw "  + leftChildRegister +  "," + p_node.getChildren().get(0).moonVarName + "(r0)\n";
		m_moonExecCode += m_mooncodeindent + "lw "  + rightChildRegister + "," + p_node.getChildren().get(1).moonVarName + "(r0)\n";
		m_moonExecCode += m_mooncodeindent + "add " + localRegister +      "," + leftChildRegister + "," + rightChildRegister + "\n"; 
		m_moonDataCode += m_mooncodeindent + "% space for " + p_node.getChildren().get(0).moonVarName + " + " + p_node.getChildren().get(1).moonVarName + "\n";
		m_moonDataCode += String.format("%-10s",p_node.moonVarName) + " res 4\n";
		m_moonExecCode += m_mooncodeindent + "sw " + p_node.moonVarName + "(r0)," + localRegister + "\n";
	...
	public void visit(AssignStatNode p_node){ 
		...
		String localRegister = this.m_registerPool.pop();
		//generate code
		m_moonExecCode += m_mooncodeindent + "% processing: "  + p_node.getChildren().get(0).moonVarName + " := " + p_node.getChildren().get(1).moonVarName + "\n";
		m_moonExecCode += m_mooncodeindent + "lw " + localRegister + "," + p_node.getChildren().get(1).moonVarName + "(r0)\n";
		m_moonExecCode += m_mooncodeindent + "sw " + p_node.getChildren().get(0).moonVarName + "(r0)," + localRegister + "\n";
	...
	public void visit(PutStatNode p_node) {
		...
		m_moonExecCode += m_mooncodeindent + "lw " + localRegister + "," + p_node.getChildren().get(0).moonVarName + "(r0)\n";
...
//	public void visit(FuncCallNode p_node) {
	public void visit(FCallNode p_node) {
		...
		for(AstNode param : p_node.getChildren().get(1).getChildren()){
			m_moonExecCode += m_mooncodeindent + "lw " + localregister1 + "," + param.moonVarName + "(r0)\n";
		...
		m_moonDataCode += String.format("%-11s", p_node.moonVarName) + "res 4\n";
		m_moonExecCode += m_mooncodeindent + "lw " + localregister1 + "," + p_node.getData() + "return(r0)\n";
		m_moonExecCode += m_mooncodeindent + "sw " + p_node.moonVarName + "(r0)," + localregister1 + "\n";
	...
	public void visit(ReturnStatNode p_node){
		...
		m_moonExecCode += m_mooncodeindent + "lw " + localregister1 + "," + p_node.getChildren().get(0).moonVarName + "(r0)\n";
		m_moonExecCode += m_mooncodeindent + "sw "   + p_node.symtab.m_name + "return(r0)," + localregister1 + "\n";
		this.m_registerPool.push(localregister1);	
	}
